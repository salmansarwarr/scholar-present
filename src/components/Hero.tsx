const HeroSection = () => {
    return (
        <section className="relative  w-full overflow-hidden md:max-h-[634px]">
            {/* Background Image */}
            <div
                className="absolute inset-0 bg-cover bg-center sm:bg-top-left bg-no-repeat 
        bg-[linear-gradient(180deg,rgba(45,158,83,0)_67.87%,#2D9E53_100%),linear-gradient(90deg,rgba(0,0,0,0)_50%,rgba(0,0,0,0.6)_100%),url('/hero.png')]"
            ></div>
                ...
                <div className="flex flex-col lg:flex-row gap-2 sm:gap-10 lg:gap-12 items-center text-center lg:text-left lg:items-end w-full">
                    ...
                    <div className="text-white space-y-2 lg:space-y-4 sm:space-y-6 max-w-[700px] w-full">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
                            Too Much Admin, Too Many Reports, Too Little Time?
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-1 lg:gap-3 sm:gap-4 pt-2 sm:pt-4">
                            <a
                                href="#demo"
                                className="bg-[#0066BF] hover:bg-blue-700 text-white font-bold px-6 sm:px-10 py-3 sm:py-4 rounded-full transition-colors duration-200 text-center text-[14px] sm:text-[16px]"
                            >
